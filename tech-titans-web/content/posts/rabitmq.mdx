---
title: RabitMQ - Message Queue (Microservices)
description: It is needed to break the synchronicity between service,
date: 2024-03-04
tags: ["rabitmq", "messagingqueue", "mircroservices"]
published: true
---
